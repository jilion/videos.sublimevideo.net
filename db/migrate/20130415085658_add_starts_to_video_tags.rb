class AddStartsToVideoTags < ActiveRecord::Migration
  def change
    add_column :video_tags, :starts, :integer, array: true, default: []
    add_column :video_tags, :last_30_days_starts, :integer
    add_column :video_tags, :last_90_days_starts, :integer
    add_column :video_tags, :last_365_days_starts, :integer
